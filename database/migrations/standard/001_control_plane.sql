...
CREATE INDEX idx_institution_plan    ON public.institution (plan_id);
CREATE INDEX idx_institution_domain  ON public.institution (email_domain);
...
CREATE INDEX idx_domain_allowlist_domain ON public.domain_allowlist (domain);
...
-- ---------------------------------------------------------------------------
CREATE TABLE public.institution_feature_grant (
    id              UUID                    PRIMARY KEY DEFAULT gen_random_uuid(),
    institution_id  UUID                    NOT NULL REFERENCES public.institution (id) ON DELETE CASCADE,
    feature_id      UUID                    NOT NULL REFERENCES public.feature (id) ON DELETE CASCADE,
...
CREATE INDEX idx_feature_grant_institution ON public.institution_feature_grant (institution_id);
CREATE INDEX idx_feature_grant_expires     ON public.institution_feature_grant (expires_at)
...
CREATE INDEX idx_platform_audit_admin       ON public.platform_audit_log (admin_id);
CREATE INDEX idx_platform_audit_institution ON public.platform_audit_log (target_institution_id);
