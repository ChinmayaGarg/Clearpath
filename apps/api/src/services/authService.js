...
export async function changePassword(
  ...
  await updatePassword(schema, userId, {
...
export function setSessionCookies(res, { rawToken, emailDomain }) {
  const cookieBase = {
    ...
    domain: IS_PRODUCTION ? ".clearpath.dev" : undefined, // ← add this
  };
...
export function clearSessionCookies(res) {
  const opts = { domain: IS_PRODUCTION ? ".clearpath.dev" : undefined };
  res.clearCookie(SESSION_COOKIE, opts);
  res.clearCookie(DOMAIN_COOKIE, opts);
}
